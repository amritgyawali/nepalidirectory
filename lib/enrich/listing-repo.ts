...
export function makeNewListing(
  ...
  const base: NewListing = {
    ...
    sourceCheckedAt: partial.sourceCheckedAt ?? null,
    contentReviewedAt: partial.contentReviewedAt ?? null,
    contentReviewedBy: partial.contentReviewedBy,
    lastMeaningfulUpdateAt: partial.lastMeaningfulUpdateAt ?? null,
    imageVerified: partial.imageVerified ?? false,
