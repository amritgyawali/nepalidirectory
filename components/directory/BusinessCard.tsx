...
export function BusinessCard({ business, sponsored = false, priceSymbol = "Rs" }: BusinessCardProps) {
  const href = business.slug === "newa-lahana" ? routes.business : `${routes.search}?q=${encodeURIComponent(business.name)}`;
  const showSponsored = sponsored || business.sponsored;
      ...
      <div className="business-card__body">
        ...
        <div className="business-card__actions">
          ...
          <Link className="button button--outline" href={href}>
            {business.categories.includes("Restaurants") ? "View Menu" : "Services"}
          </Link>
